...
import { CaretRightFilled, EyeFilled, MobileFilled, WarningFilled } from "@ant-design/icons";
        ...
        <div className={divStyle}>
          <div>
            <strong>
              ...
              {type === "chat" && (
                <CaretRightFilled style={{ fontSize: "16px" }}/>
              )}
              {type === "sms" && <MobileFilled />}
              {` ${m.author}`}
            </strong>
      ...
      >
        ...
        {hasFailed && (
          <div style={{ display: "flex", flexDirection: "column" }}>
            <WarningFilled style={{ fontSize: "5em" }} />
        ...
        {!hasFailed && url && (
          <div className={styles.media_icon}>
            <div style={{ zIndex: 123, position: "absolute" }}>
              <EyeFilled style={{ fontSize: "5em", opacity: 0.3 }} />
            </div>
            <div
